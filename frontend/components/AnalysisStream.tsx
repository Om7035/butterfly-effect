...
const STAGE_LABELS: Record<string, string> = {
  ...
  extracting: "Building causal graph...",
  simulating: "Running simulation & extracting chain...",
...
const STAGE_DESCRIPTIONS: Record<string, string> = {
  ...
  simulating: "Multi-agent ABM, then chain extraction + SNN verification",
            ...
            >
              <div style={{
                ...
                {isDone ? (
                  ...
                  <div style={{ width: "8px", height: "1.5px", borderRadius: "1px", background: "rgba(255,255,255,0.15)" }} />
                )}
              </div>
              <div style={{ flex: 1 }}>
