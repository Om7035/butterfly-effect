    ...
    >
      ...
      >
        <svg width="56" height="56" viewBox="0 0 48 48" fill="none">
          <motion.path
            d="M24 24 C18 16, 6 12, 4 20 C2 28, 12 32, 24 24Z"
            fill="rgba(124,58,237,0.8)"
            animate={prefersReduced ? {} : { opacity: [0.6, 1, 0.6] }}
            transition={{ duration: 1.5, repeat: Infinity }}
          />
          <motion.path
            d="M24 24 C30 16, 42 12, 44 20 C46 28, 36 32, 24 24Z"
            fill="rgba(124,58,237,0.8)"
        ...
        {stages.filter(s => s !== "done").map((s, i) => {
          ...
          return (
            <motion.div
              ...
              style={{ display: "flex", alignItems: "center", gap: "12px", padding: "10px 14px", borderRadius: "10px", background: isActive ? "rgba(124,58,237,0.1)" : isDone ? "rgba(52,211,153,0.05)" : "rgba(255,255,255,0.02)", border: `1px solid ${isActive ? "rgba(124,58,237,0.3)" : isDone ? "rgba(52,211,153,0.15)" : "rgba(255,255,255,0.04)"}`, transition: "all 0.3s" }}
            >
              <div style={{ width: "20px", height: "20px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, background: isDone ? "rgba(52,211,153,0.2)" : isActive ? "rgba(124,58,237,0.2)" : "rgba(255,255,255,0.05)" }}>
                {isDone ? (
            ...
            {[
              ...
              <div key={label} style={{ textAlign: "center" }}>
                <motion.div
                  ...
                  animate={{ scale: 1 }}
                  style={{ fontSize: "20px", fontWeight: "800", fontFamily: "monospace", color }}
                >
                  {value}
                </motion.div>
