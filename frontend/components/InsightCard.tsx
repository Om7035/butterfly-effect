...
const CONFIDENCE_COLORS: Record<string, string> = {
  High: "#34d399", Medium: "#60a5fa", Low: "#fbbf24",
};
...
export default function InsightCard({ insight, index, prefersReduced, activeSource, onSourceClick }: Props) {
    ...
    return (
      ...
      >
        <div style={{ padding: "12px 14px" }}>
          ...
          <p style={{ fontSize: "13px", fontWeight: "600", color: "#e2e8f0", margin: "0 0 6px 0", lineHeight: 1.4 }}>{parsed.what}</p>
          <p style={{ fontSize: "11px", color: "#64748b", margin: "0 0 8px 0", lineHeight: 1.5 }}>{parsed.why}</p>
  ...
  if (parsed.isInsight) {
    return (
      ...
      >
        ...
        <p style={{ fontSize: "12px", color: "#cbd5e1", lineHeight: "1.6", margin: 0 }}>{parsed.insightText}</p>
      </motion.div>
    );
  }
            ...
            {insight.sources.map((src, i) => {
              ...
              return (
                <button
                  ...
                  title="Filter the graph to nodes supported by this source"
                  style={{
                    fontSize: "9px",
                    ...
                    cursor: onSourceClick ? "pointer" : "default", fontFamily: "inherit",
                  }}
                >
                  {src}
                </button>
